...
public class PlacesService {
	...
	public ArrayList<Place> findPlaces(double latitude, double longitude,
			...
			Boolean useCurrentLocation, String searchBarValue,
			String pagetoken, Context context) {

		Log.d("pagetoken", "findPlaces pagetoken = " + pagetoken);
		String urlString = makeUrl(latitude, longitude, placeSpacification,
				radius, useCurrentLocation, searchBarValue, pagetoken);
		...
		try {
			...
			try {
				...
				String next_page_token1 = pref1.getString("next_page_token",
						null); // getting String
				Log.d("next_page_token1", "next_page_token1 = "
						+ next_page_token1);
	...
	// https://maps.googleapis.com/maps/api/place/search/json?location=51.5085300,-0.1257400&radius=500&types=atm&sensor=false&key=apikey
	private String makeUrl(double latitude, double longitude, String place,
			Double radius, Boolean useCurrentLocation, String searchBarValue,
			String pagetoken) {
