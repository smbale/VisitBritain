...
@Api(name = "taskApi", version = "v1",
        namespace = @ApiNamespace(ownerDomain = "backend.places.google.com",
                ownerName = "backend.places.google.com",
                packagePath=""))
public class MyEndpoint {
    ...
    public void storeTask(TaskBean taskBean) {
        ...
        try {
            Key taskBeanParentKey = KeyFactory.createKey("TaskBeanParent", "places.txt");
